        ...
        <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden border-r border-border bg-surface-raised p-12 lg:flex">
          ...
          <div className="relative space-y-4">
            ...
            <p className="max-w-sm text-muted">
              Set alerts on NSE & BSE stocks and get notified instantly on WhatsApp when your target is hit.
            </p>
          </div>
          <p className="relative text-xs text-faint">Real-time data powered by Upstox</p>
        </div>
        ...
        <main className="relative flex flex-1 items-center justify-center px-6 py-12">
          ...
          <div className="w-full max-w-md animate-slide-up">
            ...
            <div className="mb-8">
              ...
              <p className="mt-1.5 text-sm text-muted">Sign in to manage your stock alerts</p>
            </div>
            ...
            <p className="mt-8 text-center text-sm text-muted">
              No account?{" "}
              <Link href="/register" className="font-medium text-brand-600 hover:text-brand-500 dark:text-brand-400 dark:hover:text-brand-300">
                Create one free
              </Link>
            </p>
          </div>
